...
import com.example.gerardogarcias.myapplication.SolicitudesFragments.OrganismosFragment;
...
public class SolicitudesActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                navigationView.setCheckedItem(R.id.nav_solicitudes);
                return true;
    ...
    private void  goToMain(){
        Intent intent = new Intent(SolicitudesActivity.this,MainMenuActivity.class);
        startActivity(intent);
    }

    //metodo para ir a SolicitudesActivity
    private void  goToSolicitudes(){
        Intent intent = new Intent(SolicitudesActivity.this,SolicitudesActivity.class);
        startActivity(intent);
    }

    //metodo para ir a ReportesActivity
    private void  goToReportes(){
        Intent intent = new Intent(SolicitudesActivity.this,ReportesActivity.class);
        startActivity(intent);
    }

    //metodo para ir a IncidenciasActivity
    private void  goToIncidencias(){
        Intent intent = new Intent(SolicitudesActivity.this,IncidenciasActivity.class);
        startActivity(intent);
    }

    //metodo para ir a LoginActivity
    private void  goToLogin(){
        Intent intent = new Intent(SolicitudesActivity.this,LoginActivity.class);
        startActivity(intent);
    }
