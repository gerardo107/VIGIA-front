...
public class ReportesFragment extends Fragment {
    ...
    private void jsonParse(){
        ...
        String url="https://vigia-back.herokuapp.com/requests/REP/events";
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            for(int i =0; i < response.length(); i++){
                                ...
                                //obtener el codigo del tipo de Reporte
    ...
    private void  goToReportesFragments(String codigo){

        if(codigo.equals("ASP")){
            setFragment(0);
        }
        if(codigo.equals("DPS")){
            setFragment(1);
        }
        if (codigo.equals("MIM")){
            setFragment(2);
        }
