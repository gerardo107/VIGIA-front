    ...
    private void  goToMainI(){
        ...
        Registrobutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                numR = (int) (Math.random() * 5000) + 1000;;
                Intent intent = new Intent(getActivity().getApplicationContext(),MainMenuActivity.class);
                Toast.makeText(getActivity().getApplicationContext(), "Tu registro se ha creado exitosamente numero de folio:" + numR , Toast.LENGTH_LONG).show();
