...
public class ReportesActivity extends AppCompatActivity {
    ...
    private void  goToSolicitudes(){
        Intent intent = new Intent(ReportesActivity.this,SolicitudesActivity.class);
        startActivity(intent);
    }

    //metodo para ir a ReportesActivity
    private void  goToReportes(){
        Intent intent = new Intent(ReportesActivity.this,ReportesActivity.class);
        startActivity(intent);
    }

    //metodo para ir a IncidenciasActivity
    private void  goToIncidencias(){
        Intent intent = new Intent(ReportesActivity.this,IncidenciasActivity.class);
        startActivity(intent);
    }
